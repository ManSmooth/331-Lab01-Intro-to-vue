const ReviewForm = {
    ...
    <form class="review-form" @submit.prevent="onSubmit" style="display: flex;flex-direction: column; gap: 0.5rem;">
        ...
        <textarea id="review" v-model.trim="review" required />
        ...
        <div style="display:flex; gap:1rem;" id="recommended">
            <div style="display:flex; gap:1rem; align-items: center;">
                <input type="radio" name="recommend" id="yes" value="y" v-model.number="recommend" required/>
                <label for="yes">Yes</label>
            </div>
            <div style="display:flex; gap:1rem; align-items: center;">
                <input type="radio" name="recommend" id="no" value="n" v-model.number="recommend" required/>
